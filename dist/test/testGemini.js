...
async function testGeminiConnection() {
    ...
    try {
        ...
        const healthResult = await geminiService_1.geminiService.healthCheck();
        ...
        const basicTest = await geminiService_1.geminiService.generateContent({
        ...
        const academicResult = await geminiService_1.geminiService.analyzeAcademicData(dummyAcademicData);
        ...
        const financialResult = await geminiService_1.geminiService.analyzeFinancialData(dummyFinancialData);
        ...
        const stats = geminiService_1.geminiService.getStats();
        console.log(stats);
...
exports.default = testGeminiConnection;
