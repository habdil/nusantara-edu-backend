...
async function testAcademicAnalysis() {
    ...
    try {
        ...
        const strictService = new academicAnalysisService_1.default({
        ...
        const lenientService = new academicAnalysisService_1.default({
...
exports.default = testAcademicAnalysis;
