...
export class FacilityController {
  ...
  getFacilities = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const { error, value } = getFacilitiesValidation.validate(req.query);
      if (error) {
        res.status(400).json({
          success: false,
  ...
  addFacility = async (req: Request, res: Response): Promise<void> => {
    try {
      if (!req.user?.schoolId) {
        res.status(400).json({
          success: false,
      ...
      const { error, value } = createFacilityValidation.validate(req.body);
      if (error) {
        res.status(400).json({
          success: false,
  ...
  updateFacility = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      // Validate request body
      const { error, value } = updateFacilityValidation.validate(req.body);
      if (error) {
        res.status(400).json({
          success: false,
          message: 'Data tidak valid',
  ...
  getFacilityUsage = async (req: Request, res: Response): Promise<void> => {
    try {
      if (!req.user?.schoolId) {
        res.status(400).json({
          success: false,
  ...
  getFacilityUsageByFacilityId = async (req: Request, res: Response): Promise<void> => {
    try {
      if (!req.user?.schoolId) {
        res.status(400).json({
          success: false,
  ...
  addFacilityUsage = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const result = await this.facilityService.addFacilityUsage(
        facilityUsageData,
        req.user.userId,
        req.user.schoolId
      );
  ...
  updateFacilityUsageApproval = async (req: Request, res: Response): Promise<void> => {
    try {
      if (!req.user?.schoolId) {
        res.status(400).json({
          success: false,
      ...
      const result = await this.facilityService.updateFacilityUsageApproval(
        usageId,
        approvalStatus,
        req.user.schoolId
      );
  ...
  getFacilityStats = async (req: Request, res: Response): Promise<void> => {
    try {
      if (!req.user?.schoolId) {
        res.status(400).json({
          success: false,
  ...
  getFacilityUtilizationReport = async (req: Request, res: Response): Promise<void> => {
    try {
      if (!req.user?.schoolId) {
        res.status(400).json({
          success: false,
      ...
      const result = await this.facilityService.getFacilityUtilizationReport(
        req.user.schoolId,
        dateFrom,
        dateTo
      );
  ...
  getFacilityTypes = async (req: Request, res: Response): Promise<void> => {
    try {
      if (!req.user?.schoolId) {
        res.status(400).json({
          success: false,
